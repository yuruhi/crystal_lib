...
data:
  ...
  bundledCode: "# require \"../graph\"\n# require \"./graph/edge\"\nstruct WeightedEdge(T)\n\
    ...
    \ parent_p2(v : Int32, k : Int32) : Int32?\n    p = @parent[k][v]\n    p >= 0\
  ...
  code: "require \"../graph\"\n\nclass LCA(Edge, Edge2)\n  getter graph : Graph(Edge,\
    \ Edge2), depth : Array(Int32), log2 : Int32\n\n  private def dfs(vertex : Int32,\
    \ par : Int32, dep : Int32) : Nil\n    @parent[0][vertex] = par\n    @depth[vertex]\
