...
data:
  ...
  verifiedWith:
  - test/graph/topological_sort.test.cr
documentation_of: src/graph/topological_sort.cr
layout: document
redirect_from:
- /library/src/graph/topological_sort.cr
- /library/src/graph/topological_sort.cr.html
