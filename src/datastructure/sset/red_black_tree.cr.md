...
data:
  ...
  verifiedWith: []
documentation_of: src/datastructure/sset/red_black_tree.cr
layout: document
redirect_from:
- /library/src/datastructure/sset/red_black_tree.cr
- /library/src/datastructure/sset/red_black_tree.cr.html
