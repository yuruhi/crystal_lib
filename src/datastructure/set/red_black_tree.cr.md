...
data:
  ...
  requiredBy:
  - benchmarks/datastructure/set/red_black_tree.cr
  - spec/datastructure/set/red_black_tree_spec.cr
  timestamp: '2021-09-11 20:14:19+09:00'
  verificationStatus: LIBRARY_NO_TESTS
  verifiedWith: []
documentation_of: src/datastructure/set/red_black_tree.cr
layout: document
redirect_from:
- /library/src/datastructure/set/red_black_tree.cr
- /library/src/datastructure/set/red_black_tree.cr.html
