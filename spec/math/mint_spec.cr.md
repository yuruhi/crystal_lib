...
data:
  ...
  bundledCode: "require \"spec\"\n\n# require \"../../src/math/mint\"\nstruct ModInt(MOD)\n\
    ...
    \    (a * 3).should eq 9\n    (a * a).should eq 9\n    (a * MOD1).should eq 0\n\
    \    (b * MOD1).should eq 0\n    (b * b).should eq 1\n    (b * Int64::MAX).should\
    \ eq MOD1.pred * (Int64::MAX % MOD1) % MOD1\n    check_binary_operator(Mint, :*)\n\
    \    check_binary_operator(Mint2, :*)\n  end\n\n  it \"#/(other)\" do\n    a =\
    ...
    \    (a ** (10i64**18)).should eq 246336683\n    (a.pred ** (10i64**18)).should\
    \ eq 719476260\n\n    {% for type in [Mint, Mint2] %}\n      %mod = {{type}}.mod\n\
    \      0i64.step(by: %mod, to: %mod // 1000) do |x|\n        0i64.step(by: Int64::MAX,\
    \ to: Int64::MAX // 1000) do |e|\n          m = {{type}}.new(x) ** e\n       \
