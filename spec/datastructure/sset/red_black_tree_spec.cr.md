...
data:
  ...
  bundledCode: "require \"spec\"\n\n# require \"../../../src/datastructure/sset/red_black_tree\"\
    ...
    end\n\nalias S_RBT = SSet::RedBlackTree(Int32)\n\ndescribe SSet::RedBlackTree(Int32)\
    \ do\n  it \"{}\" do\n    S_RBT{3, 1, 4, 1, 5}.to_a.should eq [1, 3, 4, 5]\n \
    ...
    \  end\n\n  it \"#to_s, #inspect\" do\n    s = S_RBT{1, 2, 3, 4}\n    s.to_s.should\
    \ eq \"SSet::RedBlackTree{1, 2, 3, 4}\"\n    s.inspect.should eq \"SSet::RedBlackTree{1,\
    \ 2, 3, 4}\"\n  end\n\n  it \"big\" do\n    n = 10**4\n    s = S_RBT.new\n   \
    \ (1..n).each do |x|\n      s << x\n      s.size.should eq x\n      s.min.should\
    \ eq 1\n      s.max.should eq x\n      verify(s)\n    end\n    s.to_a.should eq\
    \ (1..n).to_a\n    (-n..n*2).each do |x|\n      s.includes?(x).should (1 <= x\
    \ <= n ? be_true : be_false)\n    end\n    (1..n).each do |x|\n      s.delete(x).should\
    \ be_true\n      s.delete(x).should be_false\n    end\n  end\nend\n\nit SSet::RedBlackTree(String)\
    \ do\n  SSet::RedBlackTree{\"a\", \"c\", \"b\"}.to_a.should eq %w[a b c]\n  SSet::RedBlackTree{\"\
    a\", \"ab\", \"abc\", \"abc\"}.to_a.should eq %w[a ab abc]\nend\n"
  code: "require \"spec\"\nrequire \"../../../src/datastructure/sset/red_black_tree\"\
  ...
  requiredBy: []
  timestamp: '2021-09-12 11:13:43+09:00'
