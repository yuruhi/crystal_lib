...
data:
  ...
  bundledCode: "# verification-helper: PROBLEM https://onlinejudge.u-aizu.ac.jp/problems/DSL_4_A\n\
    ...
    end\n\nn = read_line.to_i\nx1, y1, x2, y2 = input_column({Int64, Int64, Int64,\
  ...
  verifiedWith: []
documentation_of: test/collection/compress_test.cr
layout: document
redirect_from:
- /verify/test/collection/compress_test.cr
- /verify/test/collection/compress_test.cr.html
