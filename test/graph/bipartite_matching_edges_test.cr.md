...
data:
  ...
  bundledCode: "# verification-helper: PROBLEM https://judge.yosupo.jp/problem/bipartitematching\n\
    ...
    end\n\nl, r, m = input(i, i, i)\ngraph = BipartiteMatching.new l, r, input({i,\
  ...
  verifiedWith: []
documentation_of: test/graph/bipartite_matching_edges_test.cr
layout: document
redirect_from:
- /verify/test/graph/bipartite_matching_edges_test.cr
- /verify/test/graph/bipartite_matching_edges_test.cr.html
