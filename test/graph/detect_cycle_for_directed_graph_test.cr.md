...
data:
  ...
  bundledCode: "# verification-helper: PROBLEM https://judge.yosupo.jp/problem/cycle_detection\n\
    ...
    \nn, m = input(i, i)\ngraph = DirectedGraph.new n, (0...m).map { |i| input(i,\
  ...
  code: "# verification-helper: PROBLEM https://judge.yosupo.jp/problem/cycle_detection\n\
    require \"../../src/graph/detect_cycle\"\nrequire \"../../src/scanner\"\n\nn,\
    \ m = input(i, i)\ngraph = DirectedGraph.new n, (0...m).map { |i| input(i, i)\
    \ + {i} }\nif ans = graph.detect_cycle\n  puts ans.size, ans.join('\\n', &.cost)\n\
    else\n  puts -1\nend\n"
  dependsOn:
  ...
  requiredBy: []
  timestamp: '2021-08-18 12:52:56+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/graph/detect_cycle_for_directed_graph_test.cr
layout: document
redirect_from:
- /verify/test/graph/detect_cycle_for_directed_graph_test.cr
- /verify/test/graph/detect_cycle_for_directed_graph_test.cr.html
