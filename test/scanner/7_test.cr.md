...
data:
  ...
  attributes:
    PROBLEM: https://yukicoder.me/problems/no/350
  bundledCode: "# verification-helper: PROBLEM https://yukicoder.me/problems/no/350\n\
    # require \"../../src/scanner\"\n# ### Specifications\n#\n# ```plain\n# Inside\
    ...
    \nv, t = input(f, f)\nputs (v * t + 1e-6).to_i\n"
  code: '# verification-helper: PROBLEM https://yukicoder.me/problems/no/350
  ...
  verifiedWith: []
documentation_of: test/scanner/7_test.cr
layout: document
redirect_from:
- /verify/test/scanner/7_test.cr
- /verify/test/scanner/7_test.cr.html
