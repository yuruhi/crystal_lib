...
data:
  ...
  verifiedWith: []
documentation_of: test/scanner/14_test.cr
layout: document
redirect_from:
- /verify/test/scanner/14_test.cr
- /verify/test/scanner/14_test.cr.html
